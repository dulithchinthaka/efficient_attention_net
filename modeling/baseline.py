    ...
    def __init__(self, num_classes, last_stride, model_path,level,msmt):
        ...
        if self.level > 0:
            ...
            if self.level > 1: # second pyramid level
                self.att_s1=ECA(64,3)
                self.att_s2=ECA(256,3)
                self.att_s3=ECA(512,3)
                self.att_s4=ECA(1024,3)
                self.att_s5=ECA(2048,3)
                self.BN1 = BN2d(64)
                self.BN2 = BN2d(256)
                self.BN3 = BN2d(512)
                self.BN4 = BN2d(1024)
                ...
                if self.level > 2:
                    self.att_ss1=ECA(64,3)
                    self.att_ss2=ECA(256,3)
                    self.att_ss3=ECA(512,3)
                    self.att_ss4=ECA(1024,3)
                    self.att_ss5=ECA(2048,3)
                    self.BN_1 = BN2d(64)
                    self.BN_2 = BN2d(256)
                    self.BN_3 = BN2d(512)
                    self.BN_4 = BN2d(1024)
